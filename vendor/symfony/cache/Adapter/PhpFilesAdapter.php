...
use MantiqVendors\Symfony\Component\Cache\Traits\FilesystemCommonTrait;
    ...
    protected function doSave(array $values, int $lifetime)
    {
        ...
        foreach ($values as $key => $value) {
            ...
            if ($isStaticValue) {
                ...
                $value = str_replace('\MantiqVendors\Symfony\Component\VarExporter\Internal\\', '', $value);
                $value = "namespace MantiqVendors\Symfony\Component\VarExporter\Internal;\n\nreturn \$getExpiry ? {$expiry} : {$value};";
            }
